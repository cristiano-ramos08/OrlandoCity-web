	...
	<body>
		...
		<header>
			...
			<div id="menu-mobile" class="visible-xs">
				...
				<div class="bar-close"> <!-- class para editar o css -->
			...
			<div class="header-black">
				...
				<button id="btn-bars" type="button"><i class="fa fa-bars"></i></button> <!-- fa-search é a lupinha de pesquisa-->
				<button id="btn-search" type="button"><i class="fa fa-search"></i></button> <!-- fa-search é a lupinha de pesquisa-->
							...
							<li class="search">
								<div class="input-group">
							      ...
							      <span class="input-group-btn">
							        <button type="button"><i class="fa fa-search"></i></button> <!-- fa-search é a lupinha de pesquisa-->
							      </span>
							    </div><!-- /input-group -->
							</li>
						</ul>
