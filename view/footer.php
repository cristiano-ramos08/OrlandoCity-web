<footer>
			...
			<div class="row row-cinza-claro">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-2 text-center hidden-xs"> <!--Hidden inibe na página. É a mesma que ir no css e por display none (xs faz sumir para dispositivo mobile-->
						...
						<div class="col-md-10">
							...
							<div class="row row-cols">
								<div class="col-md-4 col-popular-post hidden-xs">
									...
									<ul class="list-unstyled"><!-- tags ul e li significam lista não ordenada ou lista sem ordem de prioridade. Pode ser usada qdo tem uma sequência de informações; -->
										<li>
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<div class="row-fluid visible-xs"> <!--visible: tornasse visivel somente no celular-->
										<div class="col-xs-6">
		...
		<script src="lib/bootstrap/js/bootstrap.min.js"></script><!--estrutura basica para trabalhar com jquery -->
		 <!-- Comando acima é a estrutura básica para trabalhar com jquery. É para ter certeza que o Jquery só vai ser executado após o carregamento da página-->
